...
- Vibe coded using Chat GPT in Jan 2026. Dedicated to hero worshippers, all sloppy toppy uncle aunties, and all dumdums who should be able to order from a french menu and program a fucking computer.
